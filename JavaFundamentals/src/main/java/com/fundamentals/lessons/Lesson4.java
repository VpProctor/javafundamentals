...
/*String objects are immutable, which means once the
...
public class Lesson4 {
    ...
    * Same as the joinWelcome method above*/
    ...
    /* equals compare the string to a specified string object */
   ...
   * to the specified case.*/
    ...
    * that are used in code, or other situation*/
    ...
    * */
    public static void main(String[] args){
        ...
        // myLesson4.anotherJoin("is not quit finished");
        ...
        // System.out.println(myLesson4.favoriteThings("Purple", "Tacos"));
        // myLesson4.iAmSingle();
