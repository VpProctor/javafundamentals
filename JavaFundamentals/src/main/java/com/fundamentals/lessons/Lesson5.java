...
public class Lesson5 {
    ...
    * The class version of this primitive is Long*/
    ...
    /*This primitive type value range of 3.4E 28 to 3.4E+38
    ...
    * The suffix of a d or D is optional. The class version of
    ...
    public void showLocalExample () {
     ...
     // A method that shows an Instance variable
        public int showInstanceExample() {
            // uses instances variables at class level
            System.out.println(myDouble);
            return (myDecimal);
        }
    ...
    * two data types automatically convert.*/
    ...
    boxing affect. This is because* a larger data
     type is converting to a smaller one, which will have a
     precision loss.*/
