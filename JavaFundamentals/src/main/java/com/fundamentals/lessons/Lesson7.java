   ...
   /* Two independent if statements*/
    ...
    public void theOrTheAnd(int value) {
        if(value > 100 || value < 50){
            System.out.println("Value is less than 50 and greater 100.");
        } // end if

        if(value % 2 == 0 && value < 30) {
            System.out.println("Value is less than and even");
        } // end if
